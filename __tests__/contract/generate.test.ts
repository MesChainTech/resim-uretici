...
describe('POST /api/generate', () => {
  const validPayload = {
    ...
    productImage: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg=='
  }
  ...
  it('should require both model and product images', async () => {
    const incompletePayload = { category: 'ecommerce', modelImage: validPayload.modelImage }
